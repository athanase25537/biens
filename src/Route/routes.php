...
function defineRoutes(
    ...
    $router->addRoute('GET', $link.'/bien-immobilier/get-bien-by-id/(\d+)$#', [$bienImmobilier, 'getBienImmobilierById']);
    ...
    $b = '#^';
    // Page d'accueil (GET /)
	$router->addRoute('GET', $b.'/$#', [$homeController, 'index']);

    // Login template
    $router->addRoute('GET', $b.'/login$#', [$homeController, 'login']);

    // Register template
    $router->addRoute('GET', $b.'/register$#', [$homeController, 'register']);

    // Biens template
    $router->addRoute('GET', $b.'/biens$#', [$homeController, 'biens']);

    // Display Bien template
    $router->addRoute('GET', $b.'/biens/display-bien/(\d+)$#', [$homeController, 'displayBien']);
}